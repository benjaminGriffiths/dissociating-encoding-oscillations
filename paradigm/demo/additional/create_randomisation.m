%% EPI_MEM_RANDOMISATION
% This script will produce a pseudo-randomised distribution of trials for
...
for r = 1 : n_rep
    ...
    % add to trial order
    trl_pr(1+((r-1)*size(tmp_pr,1)) : (r*size(tmp_pr,1)),:) = tmp_pr;
end
